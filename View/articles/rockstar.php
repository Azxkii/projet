...
<head>
    ...
    <title>RSAZXKI || ROCKSTAR</title>
</head>
<?php if (isset($_SESSION['authenticated']) && $user->getIsAdmin() && $user->getIsVerify()) { ?>
    <h1><a href="/viewCreateArticle">Créer un article</a></h1>
<?php } ?>
<h1 style="font-size: 160%; margin-bottom: -8%;">ROCKSTAR GAMES</h1>
<div class="article_psn">
    <?php
    foreach($params['articlesRockstar'] as $article) {
        /* @var ArticleRockstar $article */ ?>
        <div class="block_psn">
            <div class="zoom">
